...
BalchunayteZSobelOpTBB::BalchunayteZSobelOpTBB(const InType &input_image) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = input_image;
  GetOutput().clear();
}

bool BalchunayteZSobelOpTBB::ValidationImpl() {
...
bool BalchunayteZSobelOpTBB::PostProcessingImpl() {
  return true;
}
