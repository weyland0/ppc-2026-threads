...
ShelenkovaMShellSortSimpleMergeOMP::ShelenkovaMShellSortSimpleMergeOMP(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = in;
}

bool ShelenkovaMShellSortSimpleMergeOMP::ValidationImpl() {
  return !GetInput().empty();
}

bool ShelenkovaMShellSortSimpleMergeOMP::PreProcessingImpl() {
  GetOutput() = GetInput();
  return true;
}

bool ShelenkovaMShellSortSimpleMergeOMP::RunImpl() {
