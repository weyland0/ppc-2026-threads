...
OvchinnikovMShellSortBatcherMergeOMP::OvchinnikovMShellSortBatcherMergeOMP(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
}

void OvchinnikovMShellSortBatcherMergeOMP::ShellSort(std::vector<int> &data) {
...
std::vector<int> OvchinnikovMShellSortBatcherMergeOMP::BatcherOddEvenMerge(const std::vector<int> &left,
...
bool OvchinnikovMShellSortBatcherMergeOMP::ValidationImpl() {
  return true;
}

bool OvchinnikovMShellSortBatcherMergeOMP::PreProcessingImpl() {
  data_ = GetInput();
  return true;
}

bool OvchinnikovMShellSortBatcherMergeOMP::RunImpl() {
...
bool OvchinnikovMShellSortBatcherMergeOMP::PostProcessingImpl() {
